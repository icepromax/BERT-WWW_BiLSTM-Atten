...
robert_name='./RoBERTa_wwm_ext'
robertaTokenizer=RobertaTokenizer.from_pretrained(robert_name)
...
class BertClassifier(nn.Module):
    def __init__(self):
        ...
        self.bert=RobertaModel.from_pretrained(robert_name)
...
def GenerateDate(mode='train'):
        data_path= './data/cleaned_waimai_10k.csv'
